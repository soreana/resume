...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{tabular}{ll}
			{\bf Lead Software Engineer } design and implement middleware between cars and end users   & \\
		\end{tabular}
		\begin{itemize}
			\item Receive bulk of encrypted data from cars
			\item Load balance received data between multiple cache container
			\item Use Reinforcment Learning to select next caches  ????
	...
	\end{itemize}
	 ...
	 \begin{itemize}
	 	...
	 	\begin{itemize}
	 		\item
	 		Hands on Experience in using Router, Switch and SDN enabled equipments 
